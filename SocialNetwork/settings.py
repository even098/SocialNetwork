...
environ.Env.read_env('users/google_client_info.env', encoding='utf-8')

GOOGLE_OAUTH2_CLIENT_ID = env.str("GOOGLE_OAUTH2_CLIENT_ID")
GOOGLE_OAUTH2_CLIENT_SECRET = env.str("GOOGLE_OAUTH2_CLIENT_SECRET")
GOOGLE_OAUTH2_PROJECT_ID = env.str("GOOGLE_OAUTH2_PROJECT_ID")
BASE_BACKEND_URL = env.str("BASE_BACKEND_URL")
...
SECRET_KEY = 'django-insecure-)%sag#ixbtj!jdo8q3x9oeri(_qm5k0e!a&_6z_$aix$@drgyo'
...
EMAIL_PORT = '465'
EMAIL_HOST_USER = 'saparaliev.ersultan@yandex.ru'
EMAIL_HOST_PASSWORD = 'yxrbjzaoeghaxoat'
EMAIL_USE_SSL = True
